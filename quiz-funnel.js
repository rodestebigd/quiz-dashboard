/* ============================================================
   QUIZ FUNNEL JS — Julie Cosmétique (avec tracking)
   Fichier à uploader dans Shopify : Settings > Files
   ou dans le thème : Assets/quiz-funnel.js
   ============================================================ */

/* ============================================================
   TRACKING — Remplace l'URL par celle de ton Apps Script
   ============================================================ */
...
var sessionId = (function() {
  var id = sessionStorage.getItem('quiz_sid');
  if (!id) {
    id = Date.now().toString(36) + Math.random().toString(36).substr(2, 9);
    sessionStorage.setItem('quiz_sid', id);
  }
  return id;
})();
